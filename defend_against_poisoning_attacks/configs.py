...
parser.add_argument('--resumed_name', default='jzx_test_MR_cifar10/jzx_test_1000.pth', type=str)
...
parser.add_argument('--number_of_adversaries', default=20, type=int,
...
parser.add_argument('--aggregation_rule', default='jzx_test', type=str,
                    choices=['jzx_test','jzx_no_defense', 'avg', 'rlr', 'flame', 'foolsgold', 'roseagg', 'fltrust', 'fedcie'],
...
parser.add_argument('--mal_boost', default=40, type=int,
...
parser.add_argument('--record_res_step', default=10, type=int,
